...
const Item = props => {
  const { item } = props;
  return (
    <div className="acceptedOffersItem animated fadeIn">
      <div className="acceptedOffersItem__header">
        <span className="acceptedOffersItem__title">{item.RecordType}</span>
        <div className="acceptedOffersItem__headerinfo">
      ...
      <div className="acceptedOffersItem__body">
        <div className="acceptedOffersItem__bodyRow">
      ...
      <div className="acceptedOffersItem__footer">

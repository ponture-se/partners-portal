...
const Item = props => {
  const { item } = props;
  return (
    <div className="fundedAppsItem animated fadeIn">
      <div className="fundedAppsItem__header">
        <span className="fundedAppsItem__title">{item.RecordType}</span>
        <div className="fundedAppsItem__headerinfo">
      ...
      <div className="fundedAppsItem__body">
        <div className="fundedAppsItem__bodyRow">
      ...
      <div className="fundedAppsItem__footer">
